...
public class MainActivity extends AppCompatActivity {
    ...
    public void storeActivity(View v) {
        CommunicateWithHistoryAPI api = new CommunicateWithHistoryAPI();
        api.setMethod("insert");
        api.execute();
    }
    ...
    private class CommunicateWithHistoryAPI extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            if (methodCall.equals("insert")) {
                ...
                return null;
            } else if (methodCall.equals("fetch")) {
                // Begin by creating the query.
    ...
    private SessionReadRequest readFitnessSessionThisWeek() {
        Log.i(TAG, "Reading History API results for all sessions this week");
    ...
    private void deleteSession() {
        Log.i(TAG, "Deleting past week's session data for speed");
        Calendar cal = Calendar.getInstance();
        Date now = new Date();
        cal.setTime(now);
        long endTime = cal.getTimeInMillis();
